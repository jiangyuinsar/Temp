...
region = 'AM';
cluster_no = 1063;
coseismic_date = [19960330; 19960420;19971122;19971130;19971229;19971231;19980105;19980609;19980624;19980715;19980801;19980802;19980805;];
...
%%%%%%%%%%%%%%%%%%%%%%%%%
filename1 = dir('ER02_SAR_RAW_0P_*.gz');
filename2 = dir('ER02_SAR_IM__0P_*.gz');
...
for i = 1:size(ifg_list,1)
    ...
    ifg_foldername = [num2str(ifg_list(i,1)) '_' num2str(ifg_list(i,2)) '_ERS2_L0_WINSAR_' num2str(orbit_number) '_' num2str(frame_number)];
    ...
    orbit_type = 'ODR';
    orbit_directory = '/mnt/home/yujiang/myData/orbits/ERS2_ODR';
